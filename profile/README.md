...
| [cs2032-api-attendance](https://github.com/Maykol-Morales/cs2032-api-attendance) | API serverless de asistencia: sesiones, QR y validación por ubicación | AWS Lambda · DynamoDB · Serverless |
| [cs2032-logger](https://github.com/Maykol-Morales/cs2032-logger) | Librería de logging para Python con AWS CloudWatch · [PyPI](https://pypi.org/project/utec-logger/) | Python · boto3 · CloudWatch |
| [cs2032-logger-web](https://github.com/Maykol-Morales/cs2032-logger-web) | Visor web de logs con filtros | Gatsby · React · Tailwind |
